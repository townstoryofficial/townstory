...
contract TownStoryInventoryUpgradeable is Initializable, ERC1155Upgradeable, ERC2981Upgradeable, GameOwnerUpgradeable, PausableUpgradeable, ERC1155SupplyUpgradeable {
    ...
    function initialize() initializer public {
        __ERC1155_init("https://townstory.io/nft/inventory/{id}.json");
        __Ownable_init();
        __Pausable_init();
